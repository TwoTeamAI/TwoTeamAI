...
export function FinalCTA() {
  return (
    <section className="section-padding relative overflow-hidden" aria-labelledby="final-cta-title">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(245,158,11,0.08)_0%,_transparent_70%)]" aria-hidden="true" />
      <div className="absolute inset-0 bg-gradient-to-t from-carbon via-transparent to-transparent" aria-hidden="true" />

      <div className="container-custom relative">
        <div className="max-w-3xl mx-auto text-center">
          <span className="section-label">Ready to Build?</span>
          <h2 id="final-cta-title" className="font-display text-display-lg font-bold text-chalk tracking-tight mb-6 text-balance">
            Got an idea? <span className="text-gradient-amber">Let&apos;s build it.</span>
          </h2>
          <p className="text-body-lg text-titanium leading-relaxed mb-10 max-w-xl mx-auto">
            You bring the vision. We bring the engineering, the AI, the automation, and the obsession with production quality. No middlemen. No handoffs. Just results.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Link to="/contact" className="btn-primary animate-shimmer text-lg px-10 py-4">
              Start Your Project
            </Link>
            <a
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-body-sm text-titanium/60">
            <div className="flex items-center gap-2">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2" aria-hidden="true">
